            ...
            <h1 className="text-center font-bold text-xl">
                <div className="flex flex-col justify-center px-4 w-full lg:flex-row">
                    <div className="border-solid border-gray-400 border-2 hover:bg-white">
                        <Link className="p-4 block w-full lg:p-2 text-gray-400 hover:text-black" to={'about'}>Sobre Mi</Link>
                    </div>
                    ...
                    <div className="border-solid border-gray-400 border-2 hover:bg-white">
                        <a href={curriculum} className="p-4 block w-full lg:p-2 text-gray-400 hover:text-black">Descargar CV</a>
                    </div>
                </div>
            </h1>
        </div>
